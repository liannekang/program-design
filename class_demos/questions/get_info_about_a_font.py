...
# A font file has a bit of metadata about the font inside of it.
...
# using the random package, so we'll need to import the 'choice' method from random:
...
# 'usWidthClass'. This value ranges from 1 to 9, with 5 being a normal
# width.
...
# The weight value should be accurate to the font, and usually the width value too.
# Because humans are setting these values, sometimes they aren't right (sometimes
# for reasons, sometimes it's just an error (looking at you DAFont font files)).
# Just know that.

# If you want to find out the foundry that made a font, there is a bit of data for
# that too. Foundries usually have a registered foundry code (a list of this is
# here: https://docs.microsoft.com/en-us/typography/vendors/). Yes, Agyei Archer
# (who is going to skype into our class has foundry code !666, cheeky devil).
...
# have a font you wanted installed, it could subsitute something that was close.
...
# This is still part of the font specificiation, and some software still uses
...
# if we print panose, we'll see that it's something we haven't see yet in class,
# an object
...
# This is a bunch of things, but hopfully it is somewhat clear.
...
# Unfortunatly, fontTools doesn't have very good documentation, so reading
